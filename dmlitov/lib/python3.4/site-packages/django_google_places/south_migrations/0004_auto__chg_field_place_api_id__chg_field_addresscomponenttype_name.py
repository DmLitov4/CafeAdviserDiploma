...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.api_id'
        db.alter_column(u'django_google_places_place', 'api_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=191))

        # Changing field 'AddressComponentType.name'
        db.alter_column(u'django_google_places_addresscomponenttype', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=191))

    def backwards(self, orm):

        # Changing field 'Place.api_id'
        db.alter_column(u'django_google_places_place', 'api_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))

        # Changing field 'AddressComponentType.name'
        db.alter_column(u'django_google_places_addresscomponenttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
    ...
    models = {
        ...
        u'django_google_places.place': {
            ...
            'api_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '191'}),
