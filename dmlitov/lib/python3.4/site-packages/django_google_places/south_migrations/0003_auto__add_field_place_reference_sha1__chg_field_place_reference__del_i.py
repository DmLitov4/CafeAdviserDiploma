...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.reference_sha1'
        db.add_column(u'django_google_places_place', 'reference_sha1',
                      self.gf('django.db.models.fields.CharField')(max_length=40, unique=True, null=True, blank=True),
                      keep_default=False)

        # Now ensure we create a href_sha1 for all href rows.
        #db.execute("UPDATE `django_google_places_place` SET `reference_sha1` = SHA1(reference);")

        # Removing index on 'Place', fields ['reference']
        db.delete_index(u'django_google_places_place', ['reference'])
        
        # Changing field 'Place.reference'
        db.alter_column(u'django_google_places_place', 'reference', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Place.international_phone_number'
        db.alter_column(u'django_google_places_place', 'international_phone_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Place.international_phone_number'
        
        raise RuntimeError("Cannot reverse this migration. 'Place.international_phone_number' and its values cannot be restored.")
    
        # Adding index on 'Place', fields ['reference']
        # db.create_index(u'django_google_places_place', ['reference'])

        # Deleting field 'Place.reference_sha1'
        # db.delete_column(u'django_google_places_place', 'reference_sha1')

        # Changing field 'Place.reference'
        # db.alter_column(u'django_google_places_place', 'reference', self.gf('django.db.models.fields.CharField')(max_length=255))

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Place.international_phone_number'
        # db.alter_column(u'django_google_places_place', 'international_phone_number', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'django_google_places.place': {
            ...
            'formatted_phone_number': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'icon': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'international_phone_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'reference_sha1': ('django.db.models.fields.CharField', [], {'max_length': '40', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
